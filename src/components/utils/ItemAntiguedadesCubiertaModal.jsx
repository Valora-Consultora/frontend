...
const ItemAntiguedadesCubiertaModal = ({ isOpen, onRequestClose, idInforme, initialFormData }) => {
                                        ...
                                        <div className="grid grid-cols-12 items-center">
                                            ...
                                            <div className="col-span-5 text-center">
                                                <Field
                                                    ...
                                                    onClick={() => {
                                                        setFieldValue('hArmadoCubiertaDescripcion', true);
                                                        setFieldValue('maderaCubiertaDescripcion', false);
                                                        setFieldValue('metalicaCubiertaDescripcion', false);
                                                        setFieldValue('bovedillaCubiertaDescripcion', false);
                                                        setFieldValue('otrosCubiertaDescripcion', false);
                                                    }}
                                                />
                                                ...
                                                <Field
                                                    ...
                                                    className="form-radio h-4 w-4 "
                                                    onClick={() => {
                                                        setFieldValue('hArmadoCubiertaDescripcion', false);
                                                        setFieldValue('maderaCubiertaDescripcion', true);
                                                        setFieldValue('metalicaCubiertaDescripcion', false);
                                                        setFieldValue('bovedillaCubiertaDescripcion', false);
                                                        setFieldValue('otrosCubiertaDescripcion', false);
                                                    }}
                                                />
                                                <label className="p-2 text-gray-700 font-bold text-sm">Madera</label>
                                                <Field
                                                    type="radio"
                                                    name="CimentacionDescripcion"
                                                    ...
                                                    onClick={() => {
                                                        setFieldValue('hArmadoCubiertaDescripcion', false);
                                                        setFieldValue('maderaCubiertaDescripcion', false);
                                                        setFieldValue('metalicaCubiertaDescripcion', true);
                                                        setFieldValue('bovedillaCubiertaDescripcion', false);
                                                        setFieldValue('otrosCubiertaDescripcion', false);
                                                    }}
                                                />
                                                <label className="p-2 text-gray-700 font-bold text-sm">Metálica</label>
                                                <Field
                                                    type="radio"
                                                    name="CimentacionDescripcion"
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        setFieldValue('maderaCubiertaDescripcion', false);
                                                        setFieldValue('metalicaCubiertaDescripcion', false);
                                                        setFieldValue('bovedillaCubiertaDescripcion', true);
                                                        setFieldValue('otrosCubiertaDescripcion', false);
                                                    }}
                                                />
                                                <label className="p-2 text-gray-700 font-bold text-sm">Bovedilla</label>
                                                <Field
                                                    type="radio"
                                                    name="CimentacionDescripcion"
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        setFieldValue('metalicaCubiertaDescripcion', false);
                                                        setFieldValue('bovedillaCubiertaDescripcion', false);
                                                        setFieldValue('otrosCubiertaDescripcion', true);
                                                    }}
                                                />
...
export default ItemAntiguedadesCubiertaModal;
